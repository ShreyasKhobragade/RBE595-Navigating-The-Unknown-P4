...
class quad_control:
    def __init__(self):
        ...
        self.x_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minVel, maxVal=maxVel)
        self.y_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minVel, maxVal=maxVel)
        self.z_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minVel, maxVal=maxVel)

        # NED velocity controller. EDIT GAINS HERE
        self.vx_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minAcc, maxVal=maxAcc)
        self.vy_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minAcc, maxVal=maxAcc)
        self.vz_pid = pid(0.5, 0.1, 1, filter_tau, dt, minVal = minAcc, maxVal = maxAcc)
